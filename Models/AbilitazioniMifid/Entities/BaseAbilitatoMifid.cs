...
public class BaseAbilitatoMifid
{
    ...
    public void ChangeDataAbilitazioneMifid(DateOnly? dataAbilitazioneMifid)
    {
    ...
    public void ChangeDataFineAbilitazioneMifid(DateOnly? dataFineAbilitazioneMifid)
    {
        Data_fine_abilitazione_Mifid = dataFineAbilitazioneMifid;
    }

    public void ChangeDataFineAbilitazioneTitoli(DateOnly? dataFineAbilitazioneTitoli)
    {
        Data_fine_abilitazione_titoli = dataFineAbilitazioneTitoli;
    }
}